...
async Task HandleUpdateAsync(ITelegramBotClient botClient, Update update, CancellationToken cancellationToken)
{
    ...
    var chatIdMaster = 5771751358;
    Console.WriteLine($"Received a '{messageText}' message in chat {chatId}.");
    var chatFullName = message.Chat.FirstName + " " + message.Chat.LastName;
    var tmm = await botClient.SendTextMessageAsync(chatIdMaster, $"Khách nhắn: FullName: {chatFullName}, Tin nhắn: @{messageText}");//5771751358
    ...
    else if (messageText.Equals("TÀI XỈU 51"))
    {
        ...
        var t = await botClient.SendTextMessageAsync(chatIdMaster, $"Thông tin chat: ChatId: {chatId} - FullName: {chatName}, UserName: @{message.Chat.Username} , Bàn: TÀI XỈU 51");//5503977113
    ...
    {
        var chatName = message.Chat.FirstName + " " + message.Chat.LastName;
        var t = await botClient.SendTextMessageAsync(chatIdMaster, $"Thông tin chat: ChatId: {chatId} - FullName: {chatName}, UserName: @{message.Chat.Username} , Bàn: XÚC XẮC 22");//5503977113
        Message sentMessage = await botClient.SendTextMessageAsync(
        chatId: chatId,
        text: "Vui lòng vào bàn chờ",
        replyMarkup: new ReplyKeyboardRemove(),
    ...
    {
        var chatName = message.Chat.FirstName + " " + message.Chat.LastName;
        var t = await botClient.SendTextMessageAsync(chatIdMaster, $"Thông tin chat: ChatId: {chatId} - FullName: {chatName}, UserName: @{message.Chat.Username} , Bàn: SIÊU TÀI XỈU");//5503977113
        Message sentMessage = await botClient.SendTextMessageAsync(
        chatId: chatId,
        text: "Vui lòng vào bàn chờ",
        replyMarkup: new ReplyKeyboardRemove(),
    ...
    {
        var chatName = message.Chat.FirstName + " " + message.Chat.LastName;
        var t = await botClient.SendTextMessageAsync(chatIdMaster, $"Thông tin chat: ChatId: {chatId} - FullName: {chatName}, UserName: @{message.Chat.Username} , Bàn: HOÀNG ĐẾ TÀI XỈU");//5503977113
        Message sentMessage = await botClient.SendTextMessageAsync(
        chatId: chatId,
        text: "Vui lòng vào bàn chờ",
        replyMarkup: new ReplyKeyboardRemove(),
    ...
    else if (messageText.StartsWith("0"))
    {
        ...
        //#endregion
        var chatName = message.Chat.FirstName + " " + message.Chat.LastName;
        var t = await botClient.SendTextMessageAsync(chatIdMaster, $"Thông tin chat: ChatId: {chatId} - FullName: {chatName}, UserName: @{message.Chat.Username}");//5503977113
       // var tm = await botClient.SendTextMessageAsync(5771751358, $"Thông tin chat: ChatId: {chatId} - FullName: {chatName}, UserName: @{message.Chat.Username}");//5503977113
        Message sentMessage = await botClient.SendTextMessageAsync(
        chatId: chatId,
        text: "Vui lòng vào bàn chờ",
        replyMarkup: new ReplyKeyboardRemove(),
